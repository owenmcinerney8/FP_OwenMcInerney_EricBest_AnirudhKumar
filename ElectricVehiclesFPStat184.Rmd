...
(6) For Question 6, we wanted to change to preserve the case of a car, but only take attributes: model, fuel type, vehicle size, air pollution score, city mpge, highway mpge, combined mpge, and greenhouse gas score.  
