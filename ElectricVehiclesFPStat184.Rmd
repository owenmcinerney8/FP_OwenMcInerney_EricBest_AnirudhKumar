...
pkgs <- c("here", "dplyr", "dbplyr", "ggplot2", "readxl", "tidyverse", "knitr", "kableExtra", "leaflet", "esquisse")
...
It's obvious from our data and visualizations that owning an electric vehicle is more viable than ever. Charging stations are easily found in Pennsylvania, and it's no issue at all to go on a road trip given the excursion times of EV's.

[Discuss the results from each question]

When you decide to purchase your next vehicle, consider going electric. You're saving money and helping keep the planet clean and green at the same time.
